...
GLuint ResourceLoader2::createShaderProgram(const char *vertexFilePath,const char *fragmentFilePath) {
...
GLuint ResourceLoader2::createShader(GLenum shaderType, const char *filepath) {
...
void ResourceLoader2::initializeGlew() {
