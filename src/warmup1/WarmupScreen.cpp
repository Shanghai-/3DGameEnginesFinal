...
WarmupScreen::WarmupScreen(Application *parent) :
    m_parent(parent)
{
...
void WarmupScreen::tick(float seconds)
{
    m_gw->tick(seconds);
}

void WarmupScreen::draw()
{
    m_gw->draw();
}

void WarmupScreen::resize(int w, int h)
{
    m_gw->resize(w, h);
}

void WarmupScreen::onKeyHeld(QKeyEvent *event) {}
void WarmupScreen::onKeyPressed(QKeyEvent *event) {}
void WarmupScreen::onKeyReleased(QKeyEvent *event) {}
void WarmupScreen::onMousePressed(QMouseEvent *event) {}
void WarmupScreen::onMouseReleased(QMouseEvent *event) {}
void WarmupScreen::onScroll(QWheelEvent *event) {}
void WarmupScreen::onMouseMoved(QMouseEvent *event, int deltaX, int deltaY) {}


void WarmupScreen::onFocusGained()
{
    m_parent->getViewPtr()->captureMouse(true);
}

void WarmupScreen::onFocusLost()
{
}
